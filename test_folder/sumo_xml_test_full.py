...
if __name__=="__main__":
    ...
    for tt in range(10, 12, 1):
        for td in range(4, 5, 1):
            ...
            sumogen.generate_route_file(f'result_full_folder/{test_file}_{td}_{tt}_route.rou.xml',
                                        f'result_full_folder/{test_file}_{td}_{tt}_flow.rou.xml',
                                        f'{test_file}_detector.xml',
                                        f'result_full_folder/{test_file}_{td}_{tt}_traffic.txt',
            ...
            sumogen.make_sumocfg(f'{test_file}_{td}_{tt}.sumocfg',
                                 ...
                                 summary_path=f'result_full_folder/{test_file}_{td}_{tt}_summary.xml', summary_period=3600,
                                 edge_path=f'result_full_folder/{test_file}_{td}_{tt}.add.xml', edge_period=3600)
            s = time.time() - t
